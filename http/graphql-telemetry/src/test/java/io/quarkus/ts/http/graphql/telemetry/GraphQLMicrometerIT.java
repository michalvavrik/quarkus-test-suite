...
public class GraphQLMicrometerIT {
    ...
    @QuarkusApplication(dependencies = {
            ...
            @Dependency(artifactId = "micrometer-java21", groupId = "io.micrometer")
    })
    ...
    void verifyVirtualThreadsMetrics() throws InterruptedException {
        ...
        assertThat(virtualThreadsMetrics)
                ...
                .containsOnlyKeys(PINNED_SECONDS_COUNT, PINNED_SECONDS_MAX, PINNED_SECONDS_SUM, SUBMIT_FAILED_TOTAL)
                .values().allMatch(metricValue -> 0.0 == metricValue);
    }
